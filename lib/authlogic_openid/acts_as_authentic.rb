  ...
  module ActsAsAuthentic
    ...
    module Methods
      ...
      def save(perform_validation = true, &block)
        ...
        result = super({:validate => perform_validation})
      ...
      private
        def authenticate_with_openid
          ...
          session_class.controller.send(:authenticate_with_open_id, openid_identifier, options) do |result, openid_identifier, registration, ax|
